      ...
      <div className="mx-auto grid max-w-7xl gap-10 px-5 py-14 lg:grid-cols-3 lg:px-8">
        <div>
          ...
          <p className="mt-5 max-w-sm text-sm leading-relaxed text-muted-foreground">
            Solutions d'identification industrielle : impression, étiquetage, lecture, consommables,
            pièces, logiciels et accompagnement technique au Maroc.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="mt-4 space-y-2 text-sm text-muted-foreground">
            ...
            <li>
              <Link to="/secteurs" className="hover:text-foreground">
                Secteurs
              </Link>
            </li>
            <li>
          ...
          <ul className="mt-4 space-y-3 text-sm text-muted-foreground">
            ...
            <li className="flex gap-3">
              ...
              <span>
                ...
                <a href={CONTACT.mobileHref} className="hover:text-foreground">
                  {CONTACT.mobile}
                </a>
              </span>
            </li>
            ...
            <li className="flex gap-3">
              ...
              <a href={CONTACT.siteHref} className="hover:text-foreground">
                {CONTACT.site}
              </a>
            </li>
          </ul>
